...
In this dataset, `survived` would be used as the **label** and the other variables would be used as **features**.
...
{tidymodels} is working on a function to split multilevel data.

**INSERT JEFF'S FUNCTION HERE**
]
