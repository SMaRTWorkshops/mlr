...
![:emphasize](Validation sets) provide a third split of the dataset to do so.
...
.footnote[
"Testing" and "validation" sets are often used interchangeably, but they refer to different processes
]

]

---
# TODO: special considerations. time series, multilevel data, final fit on all data?


---
# TODO: preview of advanced (k-fold, nested cv)
