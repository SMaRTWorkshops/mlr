...
```{r}
# Import and preview the (custom) titanic dataset
...
- Or you can download the `Day_2A_Activity.Rmd` and follow along

- In either case, you will need to download the `airsatisfaction.csv` file

.footnote[[1] All files can be accessed from the workshop website: https://osf.io/3qhc8/]

--

<p style="padding-top:25px;">Afterward, there will be an activity where you will modify my code to achieve goals</p>
