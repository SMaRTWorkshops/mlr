...
In other fields, labels might be called: outcome, dependent, endogenous, or $y$ variables
...
In other fields, features might be called: predictor, independent, exogenous, or $x$ variables
