...
.right-column[
**Determine complex the model can become**
...
<p style="padding-top:20px;">The <b>data is split</b> into two (or more) independent subsets</p>

Data for training and testing the algorithm are kept **fully independent**

--

<p style="padding-top:20px;">Performance is <b>more important in the testing set</b> than in the training set</p>

This process **may be repeated** multiple times with different data splits
---
...
Cross-validation helps **mitigate overfitting** and estimate **out-of-sample** performance

There are many different cross-validation strategies, but **10-fold CV** is a great default

--

<p style="padding-top:20px;">In practice, cross-validation is often <b>nested</b> such that</p>
...
<p style="padding-top:20px;">Cross-validation can also be **stratified** to keep the splits relatively similar</p>
