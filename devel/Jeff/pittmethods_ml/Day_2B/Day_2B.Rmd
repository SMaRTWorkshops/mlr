...
- Sensitive to outliers, easy to optimize
...
- Robust to outliers, harder to optimize
- Ranges from $0$ to $+\infty$, lower is better
]
...
```{r, eval=FALSE}
# Fancy Version
data.frame(fare_true, fare_pred) %>% 
  ggplot(aes(x = fare_true, y = fare_pred)) + 
...
- Note that this will build upon the work you did in Activity 2-A!
