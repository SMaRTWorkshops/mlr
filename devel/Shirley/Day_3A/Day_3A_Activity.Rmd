...
confusionMatrix(data = logpred_test, reference = heart_test_baked$output)
confusionMatrix(data = ridgepred_test, reference = heart_test_baked$output)
confusionMatrix(data = lassopred_test, reference = heart_test_baked$output)
confusionMatrix(data = enpred_test, reference = heart_test_baked$output)
```
