...
The new $\alpha$ hyperparameter is called the elastic net mixing parameter, and ranges from [0, 1]. At $\alpha = 0$ ridge is performed and at $\alpha = 1$ lasso is performed.  
]
