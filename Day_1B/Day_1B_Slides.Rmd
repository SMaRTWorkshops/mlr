...
R is like engine of a car and RStudio is like the cabin

R packages give you extra features (i.e., functions and data)

To install a package into your library, use `install.packages("caret")`<sup>1</sup>

To load the `caret` package from your library, use `library("caret")`<sup>2</sup>
