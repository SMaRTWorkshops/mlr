...
This lecture aims to tie it all together and ![:emphasize](build a model from start to finish).
...
Importantly, the goal of `fit_resamples()` is to ![:emphasize](measure model importance).
