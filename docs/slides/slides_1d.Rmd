...
.footnote[
[1] Technically this is redundant because `linear_reg()` already implies `mode = regression`; could be dropped. 
]
...
.pull-left[
Building different models is very straightforward in {parsnip}.

This makes it easy to try out multiple model options at once.

Let's try specifying a variety of frequentist and bayesian models: 

- Linear regression (frequentist)

- Linear regression (bayesian)

- Logistic regresion (frequentist)
