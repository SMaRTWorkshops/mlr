...
date: 'Day 4B &emsp; &emsp; August 11, 2022'
output:
...
<p style="padding-top:30px;">**Features** used to predict tend to be cheaper or easier to measure in new data. 
...
**Identify a concern with each sentence in a paper you're reading.**
...
b) Ridge is not a form of regularization.
...
"*Our model provided excellent predictions, with an AUC of 0.59.*"

a) AUC is not a good performance metric.

b) An AUC of 0.59 isn't very good.

c) An AUC of 0.59 is not within the range of possible AUC values. 
