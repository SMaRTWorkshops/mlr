...
:-: | :--: | :---- | :--- | :---------
1 | A | Conceptual introductions | Girard | https://youtu.be/vD3w54Y4OCI
1 | B | Logistics and data exploration | Wang | https://youtu.be/MMsf544NsH8
2 | A | Feature engineering | Girard | https://youtu.be/CPVy1Mxqzu4
2 | B | Predictive modeling basics | Girard | https://youtu.be/0HaLHcPSPVk
3 | A | Regularized regression | Wang | https://youtu.be/nTpVaUnsjfk
3 | B | Decision trees and random forests | Wang | https://youtu.be/tEpudktDIac
4 | A | Support vector machines | Girard | https://youtu.be/Ydzxe1NDfiw
4 | B | Practical matters and advice | Wang | https://youtu.be/zM4Ebex9KW8
5 | A | Panel Q&A and discussion | Both | https://youtu.be/00g3ZvASlUQ
5 | B | Hackathon and consultation | Both | 

Video recordings of the course meetings have been posted as private YouTube videos (see the links in the table above). In order to access them, you must log into YouTube using the email address that was invited to view it. If you would like us to invite a different email address than the one you registered for the course with, please let us know.
